...
public class LambdaQueryChainWrapper<T> extends AbstractChainWrapper<T, SFunction<T, ?>, LambdaQueryChainWrapper<T>, LambdaQueryWrapper<T>>
    ...
    public boolean getDistinct() {
        throw ExceptionUtils.mpe("can not use this method for \"%s\"", "getDistinct");
    }

    @Override
    public LambdaQueryChainWrapper<T> distinct() {
        throw ExceptionUtils.mpe("can not use this method for \"%s\"", "distinct");
    }
}
