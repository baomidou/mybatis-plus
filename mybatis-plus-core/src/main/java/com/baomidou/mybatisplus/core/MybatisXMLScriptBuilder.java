...
public class MybatisXMLScriptBuilder extends BaseBuilder {
    ...
    private static final Map<String, String> CACHE_STRING = new ConcurrentHashMap<>();
     ...
     */
    private static String cacheStr(String str) {
        if (str == null) {
            return null;
        }
        return CACHE_STRING.putIfAbsent(str, str);
    }
