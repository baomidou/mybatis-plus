...
public class ServiceImpl<M extends BaseMapper<T>, T> implements IService<T> {
    ...
    public boolean delete(Condition condition) {
        return retBool(baseMapper.delete(condition));
    }

    @Override
    public boolean delete(Condition condition, T entity) {
        return false;
    }
    ...
    public boolean update(T entity, T newEntity) {
        return retBool(baseMapper.update(entity, newEntity));
    }
    ...
    @Override
    public int selectCount(Condition condition, T entity) {
        return 0;
    }
    ...
    @Override
    public List<T> selectList(Condition condition, T entity) {
        return null;
    }

    public T selectOne(Condition condition, T entity) {
        List<T> list = baseMapper.selectList(condition, entity);
    ...
    @Override
    public Page<T> selectPage(Page<T> page, Condition condition) {
        page.setRecords(baseMapper.selectPage(page, condition));
        return page;
    }

    @Override
    public Page<T> selectPage(Page<T> page, Condition condition, T entity) {
        return null;
    }
