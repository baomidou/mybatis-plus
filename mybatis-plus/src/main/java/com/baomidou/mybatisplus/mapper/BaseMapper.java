...
public interface BaseMapper<T> {
     ...
     * @return
     */
    int update(@Param("et") T entity, @Param("ew") T newEntity);
     ...
     * @return
     */
    int update(@Param("et") T entity, @Param("ew") T newEntity, Condition condition);
     ...
     * </p>
     *
     * @param condition 实体对象封装操作类（可以为 null）
     * @return List<T>
     */
     ...
     * @return List<T>
     */
    List<T> selectPage(RowBounds rowBounds, Condition condition);

    List<T> selectPage(RowBounds rowBounds, Condition condition, T entity);
