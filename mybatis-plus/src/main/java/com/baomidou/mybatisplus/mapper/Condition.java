 ...
 * WARRANTIES OR EntityConditionS OF ANY KIND, either express or implied. See the
...
public class Condition {
     ...
     * @return this
     */
    public Condition where(String sqlWhere, Object... params) {
     ...
     *
     * @param isAdd    是否添加
     * @param sqlWhere WHERE条件片段
     * @param params   参数集
     * @return this
     */
    public Condition whereIf(boolean isAdd, String sqlWhere, Object... params) {
        if (isAdd) {
            sql.WHERE(formatSql(sqlWhere, params));
        }
        return this;
     ...
     * @return this
     */
    public Condition and(String sqlAnd, Object... params) {
     ...
     * @return this
     */
    public Condition andNew(String sqlAnd, Object... params) {
     ...
     * @return this
     */
    public Condition or(String sqlOr, Object... params) {
     ...
     * 输出： WHERE (name='zhangsan' AND id=11) OR (statu=1)
     * </p>
     *
     ...
     * @return this
     */
    public Condition orNew(String sqlOr, Object... params) {
     ...
     */
    public Condition having(String sqlHaving, Object... params) {
     ...
     * @return this
     */
    public Condition orderBy(String columns) {
     ...
     * @return this
     */
    public Condition orderBy(String columns, boolean isAsc) {
     ...
     * @return this
     */
    public Condition isNotNull(String columns) {
     ...
     * @return this
     */
    public Condition isNull(String columns) {
        sql.IS_NULL(columns);
        return this;
    }
     ...
     * @return this
     */
    public Condition exists(String value) {
        sql.EXISTS(value);
        return this;
    }
     ...
     * @return this
     */
    public Condition notExists(String value) {
     ...
     * @return this
     */
    public Condition in(String column, String value) {
        sql.IN(column, value);
        return this;
    }
     ...
     * @return this
     */
    public Condition notIn(String column, String value) {
     ...
     * @return this
     */
    public Condition between(String column, String begin, String end) {
        sql.BETWEEN_AND(column, begin, end);
        return this;
    }
