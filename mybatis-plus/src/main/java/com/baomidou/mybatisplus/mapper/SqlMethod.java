...
public enum SqlMethod {
	...
	UPDATE_BATCH_BY_ID_MYSQL("updateBatchById", "mysql 根据ID 批量修改数据", "<script><foreach collection=\"list\" item=\"item\" index=\"index\" separator=\";\">UPDATE %s %s WHERE %s=#{%s}</foreach></script>"),
