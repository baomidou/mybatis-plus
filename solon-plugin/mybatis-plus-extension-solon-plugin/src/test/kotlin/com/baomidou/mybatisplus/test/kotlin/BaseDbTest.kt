...
abstract class BaseDbTest<T> : TypeReference<T>() {
    ...
    init {
        ...
        val createStatement = ds.connection.createStatement();
        ...
        if (StringUtils.isNotBlank(tableDataSql)) {
            createStatement.executeUpdate(tableDataSql);
        }
    ...
    private fun dataSource(): DataSource {
        ...
        config.username = "sa"
        config.password = ""
        config.jdbcUrl = "jdbc:h2:mem:test;MODE=mysql;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE"
